...
## Author
Leiliany Davila - COSC 2436, Spring 2026

## Description
This repository is a collection of labs completed in COSC 2436. It covers important topics in data structures and algorithms such as searching, sorting, recursion, graphs, and dynamic programming.
Each chapter includes Python programs that solve different problems, along with a lab report that explains how the algorithm works, shows results, and includes short reflections. All of the code has been tested and works correctly for the required examples.
